...
<html>
    ...
    <body>
        ...
        <div class="container mt-4">
            <div class="container mt-4">
                <c:if test="${not empty followManga}">
                    <c:forEach var="manga" items="${followManga}">
                        <div class="d-flex align-items-center mb-4 p-3 border rounded shadow-sm">
                            ...
                            <div class="ms-3 d-flex flex-column gap-2 text-end">
                                <a href="unfollowManga?username=${acc.user}&id=${manga.id}" class="btn btn-danger btn-sm">Bỏ theo dõi</a>
                            </div>
                        </div>
                    </c:forEach>
                </c:if>
            </div>
            <c:if test="${empty followManga}">
                <p>Không có truyện</p>
            </c:if>
    </body>
</html>
