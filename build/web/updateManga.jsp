...
<html>
    ...
    if (userType == null || (!userType.equals("admin") && !userType.equals("uploader"))) {
    ...
    <body>
        <header>
            ...
            <div class="bg-primary">
                <div class="container py-4">
                    <!-- Breadcrumb -->
                    <nav class="d-flex">
                        <h6 class="mb-0"><a href="home" class="text-white-50">Trang chủ</a></h6>
                    </nav>
                    <!-- Breadcrumb -->
                </div>
            </div>
        ...
        <form action="updateManga" method="post" enctype="multipart/form-data">
            <input type="hidden" name="username" value="${username}">
            <input type="hidden" name="mangaId" value="${mangaId}">
            Tên Chap: <input type="text" name="title" required>
            <br>
            Chọn file: <input type="file" name="images" accept="image/*" multiple required><br>
